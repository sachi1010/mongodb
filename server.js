...
const server =http.createServer(async(req,res)=>{
    ...
    if (req.url === "/api/entries" && req.method === "GET") {
      ...
      else if (req.url === "/api/entries" && req.method === "POST") {
        let body = "";
      ...
      else if (req.url.startsWith("/api/entries/") && req.method === "PUT") {
  ...
  else if (req.url.startsWith("/api/entries/") && req.method === "DELETE") {
    const id = req.url.split("/")[3];
